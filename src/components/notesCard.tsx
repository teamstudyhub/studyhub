...
interface notesprops{
  title:string,likes:number,dislikes:number
}

export default function Ncard({title,likes,dislikes}:notesprops)  {
  ...
  return (
    <div className="bg-white rounded-md flex shadow-lg border border-gray-700 p-6 w-[340px] h-[140px] overflow-y-hidden overflow-x-auto">
      <div className="px-4">
        <div className="bg-white rounded-md shadow-lg border border-gray-300 p-1 w-[167px] h-[78px]">
          <p className="text-black text-center mt-1" style={{ fontSize: '17px' }}><b>{title}</b></p>
